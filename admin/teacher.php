...
<div class="container" style="margin-top:30px">
  <div class="card">
      ...
      <div class="row">
        <div class="col-md-9">Lista de Analistas</div>
    ...
    <form method="post" id="teacher_form" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Qualificação <span class="text-danger">*</span></label>
              <div class="col-md-8">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <span class="text-muted">Somente .jpg e .png são permitidos</span><br />
...
<div class="modal" id="viewModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Detalhes do Analista Responsável</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
